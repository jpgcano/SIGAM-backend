...
// Update basic user info (protected, Manager only).
...
// Activate/deactivate user (protected, Manager only).
router.patch('/:id/estado', authMiddleware, permit('users', 'activate'), validateRequired(['activo']), userController.updateEstado);
